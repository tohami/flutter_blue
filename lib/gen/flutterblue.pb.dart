...
class BluetoothDevice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BluetoothDevice', createEmptyInstance: create)
    ...
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPaired', protoName: 'isPaired')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.bool get isPaired => $_getBF(3);
  @$pb.TagNumber(4)
  set isPaired($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasIsPaired() => $_has(3);
  @$pb.TagNumber(4)
  void clearIsPaired() => clearField(4);
}
